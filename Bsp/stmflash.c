...
// const uint8_t FLASH_SAVED_DATA[STM_SECTOR_SIZE*2]={0xAA};

// #define SAVED_NUM 400
// MY_TASK_EXT TYPE_UNION_SAMPLE_DATA SAVED_DATA[SAVED_NUM];

// const TYPE_UNION_SAMPLE_DATA FLASH_SAVED_DATA[SAVED_NUM];
...
void STMFLASH_Write(u32 WriteAddr,u16 *pBuffer,u16 NumToWrite)	
{
	...
	if(WriteAddr<STM32_FLASH_BASE||(WriteAddr>=(STM32_FLASH_BASE+2048*STM32_FLASH_SIZE)))return;//非法地址

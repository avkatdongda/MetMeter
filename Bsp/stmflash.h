...
#define FLASH_SAVE_PARA_ADDR    STM32_FLASH_BASE+STM_SECTOR_SIZE*(STM32_FLASH_SIZE-1)  //系统参数保存地址：最后1K
// #define FLASH_SAVE_DATA_ADDR    STM32_FLASH_BASE+STM_SECTOR_SIZE*(STM32_FLASH_SIZE-21) //采集数据保存地址：20K

// extern const TYPE_UNION_SAMPLE_DATA FLASH_SAVED_DATA[];
